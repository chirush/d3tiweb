		                ...
		                <div class="container">
		                    <div class="row align-items-center">
		                        <div class="col-md-4 custom-navbar-size align-self-center">
		                            <h4 class="preview-text-post">Preview Post</h4>
		                        </div>
		                        <div class="col-md-8 d-flex justify-content-end align-items-center">
									<form method="post" action="{{ url ('/d3ti-admin/publish_post/process/'.$data->post_id) }}" enctype="multipart/form-data" onsubmit="return confirm('Are you sure you want to publish the post?')">
									@csrf
					               	@method('PUT')
									  <input type="submit" name="submit" class="preview-publish-button" value="Publish">
									</form>
		         ...
		         <div class="row">
		            <div class="col-lg-8 posts-list">
		               <div class="single-post">
		                  <small><a class="">Home</a> >  <a class="">News</a> >  <a class="">{{ $data->post_title }}</a></small>
